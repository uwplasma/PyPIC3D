...
def kernel_parameters(
    *,
    ...
    static_parameters = StaticParameters(
        ...
        electrostatic_schwarz_tol=float(electrostatic_schwarz_tol),
        electrostatic_schwarz_max_iterations=int(electrostatic_schwarz_max_iterations),
...
def kernel_parameters_from_values(parameter_set, dynamic_values=None):
    ...
    return kernel_parameters(
        ...
        electrostatic_schwarz_tol=parameter_set.get("electrostatic_schwarz_tol", 1.0e-6),
        electrostatic_schwarz_max_iterations=parameter_set.get("electrostatic_schwarz_max_iterations", 500),
        electrostatic_local_cg_tol=parameter_set.get("electrostatic_local_cg_tol", 1.0e-6),
        electrostatic_local_cg_max_iterations=parameter_set.get("electrostatic_local_cg_max_iterations", 500),
...
def particle_parameters_from_values(parameter_set, tile_shape=None, dynamic_values=None):
    ...
    static_parameters = StaticParameters(
        ...
        tile_shape=tile_shape,
        electrostatic_schwarz_tol=float(parameter_set.get("electrostatic_schwarz_tol", 1.0e-6)),
        electrostatic_schwarz_max_iterations=int(parameter_set.get("electrostatic_schwarz_max_iterations", 500)),
