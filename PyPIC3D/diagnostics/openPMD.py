...
# def write_openpmd_iteration(particles, fields, world, constants, output_dir, t, filename="fieldparticle_data", file_extension=".bp"):
#     """
#     Write particles and fields to a single openPMD file at iteration t.
#     """
#     E, B, J, rho, *rest = fields
#     field_map = {
#         "E": E,
...
#     series = _open_openpmd_series(output_path, filename, file_extension=file_extension)
#     iteration = series.iterations[int(t)]
#     _configure_openpmd_iteration(iteration, t, world)
#     _write_openpmd_fields_to_iteration(iteration, field_map, world)
#     _write_openpmd_particles_to_iteration(iteration, particles, constants)
...
# def write_openpmd_particles(particles, world, constants, output_dir, t, filename="particles", file_extension=".bp"):
#     """
#     Write particles to a single openPMD file at iteration t.
#     """
...
# def write_openpmd_fields(fields, world, constants, output_dir, t, filename="fields", file_extension=".bp"):
#     """
#     Write fields to a single openPMD file at iteration t.
#     """
#     E, B, J, rho, *rest = fields
#     field_map = {
#         "E": E,
