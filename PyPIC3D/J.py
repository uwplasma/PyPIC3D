...
def J_from_rhov(particles, J, constants, world, grid):
    ...
    if particles:
        ...
        total_x = jnp.concatenate( [species.get_backward_position()[0] for species in particles] )
        total_y = jnp.concatenate( [species.get_backward_position()[1] for species in particles] )
        total_z = jnp.concatenate( [species.get_backward_position()[2] for species in particles] )
