...
def _open_openpmd_series(output_dir, filename):
...
def write_openpmd_fields(fields, world, output_dir, t, filename="fields.h5"):
    """
    ...
    series = _open_openpmd_series(output_dir, filename)
...
def write_openpmd_particles(particles, world, constants, output_dir, t, filename="particles.h5"):
    """
...
def write_openpmd_iteration(particles, fields, world, constants, output_dir, t, filename="openpmd.h5"):
    """
